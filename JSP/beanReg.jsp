...
<title>로그인 실습</title>
<jsp:useBean id="dto" class="studuserpkg.StuduserDTO"></jsp:useBean>
<jsp:setProperty name="dto" property="*"/>
<jsp:useBean id="dao" class="studuserpkg.StuduserDAO"></jsp:useBean>
</head>
<body><header><h2>실습을 환영합니다.</h2></header>
<nav><ul>
<li><a href="./beanLogin.html">로그인</a></li><li><a href="./beanReg.html">회원등록</a></ul></nav>
<section>
<fieldset class="fset"><legend>등록 결과</legend>
<% if(dto.getStud_id()==null || dto.getStud_passwd()==null||dto.getStud_name()==null||dto.getStud_phone()==null
	||dto.getStud_gender()==null ||dto.getStud_email()==null ||dto.getStud_id().trim().equals("")||dto.getStud_passwd().trim().equals("")
	||dto.getStud_name().trim().equals("")||dto.getStud_phone().trim().equals("")||dto.getStud_gender().trim().equals("")
...
</fieldset></section><footer><p>&copy;20XX MAde by Korea. All right reversed</footer></body>
</html>
